                        ...
                        <div className='w-full'>
                            ...
                            <div className='mt-5'>
                                <form action="">
                                    ...
                                    <div className='my-7'>
                                        <button type='submit' className='w-full bg-black text-white border-1 py-4 rounded-md cursor-pointer transition duration-500 hover:tracking-widest'>Login</button>
                                    </div>

                                    <p className='text-center text-sm text-gray-500'>Don't have an account yet?
                                        <Link to="/signUp" className="cursor-pointer text-black"> Sign Up</Link>
                                    </p>
